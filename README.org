...
=ascii-tree-convert= does the reverse: converts tree-structured text (like output
...
#+begin_example
M-x ascii-tree-convert
#+end_example

A buffer named =*ascii-tree-convert-result*= opens with org-mode formatted content.
...
Running =M-x ascii-tree-convert= produces:
